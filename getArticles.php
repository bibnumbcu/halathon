...
$firstQuery = $apiUrl.'?q=*:*&fq=docType_s:ART&fq=producedDateY_i:2020&fq='.urlencode('submitType_s:file OR (submitType_s:notice AND linkExtId_s:(openaccess OR arxiv OR pubmedcentral))');

//2ème requête pour les articles de type notice de 2020 n'ayant pas d'accès extérieur au texte
$secondQuery = $apiUrl.'?q=*:*&fq=docType_s:ART&fq=producedDateY_i:2020&fq=submitType_s:notice&fq=NOT(linkExtId_s:openaccess%20OR%20arxiv%20OR%20pubmedcentral)&wt=json';
